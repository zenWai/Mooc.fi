  ...
  describe('when logged in', function () {
    ...
    describe('when a blog is created', function () {
      beforeEach(function () {
        ...
        cy.get("#create-form-input-title").should("be.visible").type("Blog Title Test Create");
        cy.get("#create-form-input-author").should("be.visible").type("Name Author");
        cy.get("#create-form-input-url").should("be.visible").type("https://www.google.com");
      ...
      it('Blog created successfully', function () {
        cy.get('#blog-titleauthor').should('be.visible').should('contain', 'Blog Title Test Create By Name Author');
      })
      it('A blog can be liked, increase and decrease count', function () {
        cy.get('.blog-parent-div').eq(0).within(() => {
      ...
      it('Creator of the blog see the Delete button and delete it', function () {
        ...
        cy.get('.success').should("be.visible").should('contain', 'Post deleted successfully');
      })
      ...
      it('blogs are ordered according to likes with the blog with the most likes being first', function () {
        ...
        cy.get("#togglable-show-label-button").contains("Create New").click();
        cy.get("#create-form-title").should("be.visible");
        cy.get("#create-form-input-title").should("be.visible").type("new Blog Created");
        cy.get("#create-form-input-author").should("be.visible").type("new Name Author");
        cy.get("#create-form-input-url").should("be.visible").type("https://www.newgoogle.com");
        cy.get("#create-form-create-post-button").click();
